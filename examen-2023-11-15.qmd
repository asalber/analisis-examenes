...
:::{.callout-tip collapse="true"}
## Solución
Como $-1\leq \operatorname{sen}(t)\leq 1$ y $-1\leq \cos(t)\leq 1$ $\forall t\in\mathbb{R}$, en particular, para $t>1$se tiene que 
...
por el [teorema de comprensión de funciones](https://aprendeconalf.es/analisis-manual/06-limites.html#thm-compresi%C3%B3n-funciones), se tiene que 
