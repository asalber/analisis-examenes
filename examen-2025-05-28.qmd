...
:::{.callout-tip collapse="true"}
## Solución
a.  La serie $\displaystyle \sum_{n=1}^\infty \frac{\ln(n)}{n^2}$ es de términos positivos, por lo que, utilizando el [criterio de la integral](https://aprendeconalf.es/analisis-manual/09-series.html#thm-criterio-integral), tenemos
