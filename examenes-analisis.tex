...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, borderline west={3pt}{0pt}{shadecolor}, enhanced, sharp corners, frame hidden, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, colback=white, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, rightrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, left=2mm, opacityback=0, coltitle=black, breakable]
