...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, interior hidden, borderline west={3pt}{0pt}{shadecolor}, sharp corners, frame hidden, enhanced]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toptitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, left=2mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, arc=.35mm, colback=white, opacityback=0]
...
Como \(-1\leq \operatorname{sen}(t)\leq 1\) y \(-1\leq \cos(t)\leq 1\)
\(\forall t\in\mathbb{R}\), en particular, para \(t>1\)se tiene que

\[
\begin{gathered}
0 < 10t-1 \leq 10t+\cos(2t) \leq 10t+1 \\
0 < 4t-2 \leq 4t+2\operatorname{sen}(t) \leq 4t+2
\end{gathered}
\]
...
\[
\frac{10t-1}{4t+2} \leq \frac{10t+\cos(2t)}{4t+2\operatorname{sen}(t)} \leq \frac{10t+1}{4t-2}.
\]
...
de comprensión de funciones}, se tiene que
...
\item
  ...
  del vector \((-1/2, 1)\). La tasa de variación del consumo la da la
